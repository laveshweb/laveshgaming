...
import Bento1 from '../../public/images/bento-card1.png'
import Bento2 from '../../public/videos/bento-card2.mp4'
import Bento3 from '../../public/videos/bento-card3.mp4'
import Bento4 from '../../public/videos/bento-card4.mp4'
import Bento5 from '../../public/videos/bento-card5.mp4'
import Bento6 from '../../public/images/bento-card5.png'
...
<video src={Bento2} autoPlay muted loop playsInline className='w-full h-full object-cover'></video>
</div>
        </div>
    <div className='md:col-span-2 space-y-4 md:space-y-6'>
      <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6'>
       ...
       <video src={Bento3} autoPlay muted loop playsInline className='w-full h-full object-cover'></video>
       <h1 className='absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 font-bold text-2xl  hover:text-yellow-400 transition-all duration-300 text-nowrap  '>Scoriox</h1>
        ...
        <div className='relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105 cursor-pointer'>
       <video src={Bento4} autoPlay muted loop playsInline className='w-full h-full object-cover'></video>
       <h1 className='absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 font-bold text-2xl  hover:text-yellow-400 transition-all duration-300 text-nowrap '>Foxix</h1>
         ...
         <video src={Bento5} autoPlay muted loop playsInline className='w-full h-full object-cover'></video>
